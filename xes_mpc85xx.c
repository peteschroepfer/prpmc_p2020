...
//add XES5500 P2020 Support	
machine_arch_initcall(xes_p2020, mpc85xx_common_publish_devices);
...
//add XES5500 P2020 Support	
static int __init xes_p2020_probe(void)
{
	return of_machine_is_compatible("xes,xpedite5500");
}
...
//add XES5500 P2020 Support	
define_machine(xes_p2020) {
	.name			= "X-ES P2020",
	.probe			= xes_p2020_probe,
	.setup_arch		= xes_mpc85xx_setup_arch,
	.init_IRQ		= xes_mpc85xx_pic_init,
#ifdef CONFIG_PCI
	.pcibios_fixup_bus	= fsl_pcibios_fixup_bus,
